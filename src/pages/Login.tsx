    ...
    <div className="min-h-screen w-full flex bg-white overflow-hidden font-sans">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50 animate-fade-in-up">
        <div className="max-w-md w-full text-center">
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-3">¡Hola de nuevo!</h2>
          ...
          <button
            onClick={handleLogin}
            className="w-full group relative flex items-center justify-center gap-4 bg-white text-gray-800 px-8 py-4 rounded-2xl border-2 border-gray-200 hover:border-indigo-500 hover:shadow-xl transition-all duration-300 active:scale-95 font-bold text-lg overflow-hidden"
          >
